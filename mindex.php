...
<div class="card w-100 text-center shadowBlue">
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Current CIBIL SCORE</th>
    ...
    ?>
      <tr>
        ...
        <td>
          ...
          <a href="mnotice.php?id=<?php echo $row['id'] ?>" class='btn btn-primary btn-sm' data-toggle='tooltip' title="Send Notice On CIBIL Score to this">Send Notice On CIBIL Score</a>
